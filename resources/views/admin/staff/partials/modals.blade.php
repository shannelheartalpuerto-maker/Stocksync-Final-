@foreach($staff as $member)
    ...
    <div class="modal fade" id="ajax-suspendStaffModal{{ $member->id }}" tabindex="-1" aria-hidden="true">
    ...
    <div class="modal fade" id="ajax-deleteStaffModal{{ $member->id }}" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content border-0 shadow-lg">
