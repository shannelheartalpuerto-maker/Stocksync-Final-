        ...
        <div class="card-body-custom">
            ...
            <div class="row g-4">
                ...
                <div class="col-md-8">
                    ...
                    <div class="table-responsive" id="staffTableWrap">
                        <table class="table table-hover align-middle mb-0">
                            ...
                            <tbody id="staffTableBody">
                                @include('admin.staff.partials.rows', ['staff' => $staff])
...
<!-- Modals Section -->
<div id="ajaxStaffModals">
    @include('admin.staff.partials.modals', ['staff' => $staff])
</div>
...
document.addEventListener('DOMContentLoaded', function() {
    const createForm = document.querySelector('form[action="{{ route('admin.staff.store') }}"]');
    const tableWrap = document.getElementById('staffTableWrap');
    const tbody = document.getElementById('staffTableBody');
    const modalsMount = document.getElementById('ajaxStaffModals');
    ...
    async function refreshList() {
        const resp = await fetch(`{{ route('admin.staff.index') }}`, { headers: { 'X-Requested-With': 'XMLHttpRequest' } });
    ...
    document.addEventListener('submit', async function(e) {
        const form = e.target;
        const isUpdate = form.action.includes('/admin/staff/') && form.querySelector('input[name="_method"][value="PUT"]');
        const isDelete = form.action.includes('/admin/staff/') && form.querySelector('input[name="_method"][value="DELETE"]');
