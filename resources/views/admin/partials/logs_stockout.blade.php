    ...
    <table class="table table-hover align-middle">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <button type="button" class="btn btn-sm btn-link text-decoration-none" data-bs-toggle="modal" data-bs-target="#stockOutDetailsModal{{ $log->id }}">
            ...
            @empty
            <tr>
                <td colspan="5" class="text-center text-muted py-4">No stock out records found.</td>
            </tr>
            @endforelse
        </tbody>
    </table>
        ...
        <div class="modal-content shadow">
            <div class="modal-header bg-light">
                <h5 class="modal-title fw-bold">
                    <i class="fa-solid fa-arrow-up me-2 text-primary"></i>Stock Out Details
                </h5>
            ...
            <div class="modal-body p-4">
                <div class="row g-3">
                    ...
                    <div class="col-12">
                        <label class="small text-muted fw-bold text-uppercase">Quantity Out</label>
                        <div><span class="badge bg-primary">-{{ $log->quantity }}</span></div>
                    </div>
                    <div class="col-12">
                        <label class="small text-muted fw-bold text-uppercase mb-2">Reason</label>
